...
import ModalCloseButton from '../../tuned/components/Card/ModalCloseButton';
...
export const ModalHeader: FC<IModalHeaderProps> = (props) => {
	const { isTuned = false, children, className, titleId, setIsOpen, ...rest } = props;
	...
	// TUNED
	const classTuned = classNames('flex items-center justify-between');

	return (
		<div
			data-component-name='Modal/ModalHeader'
			className={classNames(isTuned ? classTuned : classes, className)}
			{...rest}>
...
export const ModalBody: FC<IModalBodyProps> = (props) => {
	...
	// TUNED
	const classTuned = classNames('grow', {
		'overflow-y-auto': isScrollable,
	});
