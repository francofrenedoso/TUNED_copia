...
# El proyecto de TUNED se encuentra dentro de src/tuned

A excepción de las rutas que se siguió la estructura del template

En src/tuned/readme.txt hay más detalles de los cambios

**Vista previa del dashboard en 1440px tomada en navegador Edge (Google Chrome se ve igual):**

**src/tuned/Screen_final_1440px.jpeg**



Nota: los navegadores firefox y derivados tienen pequeñas diferencias en la renderización del sistema de grilla y algunos componentes, cambios estéticos menores
